...
uniform float uTime;
uniform float uStart0; // loader progress fraction
uniform float uStart1; // secondary time-based control
uniform float uStart2; // opacity control
...
void main() {
  float prog = mix(0.0, 1.0, uStart0);
  float noise = cnoise(
    vec2(
